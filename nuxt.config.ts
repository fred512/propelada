  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@600;700;800;900&family=Outfit:wght@400;500;600;700;800&display=swap' },
        { rel: 'icon', type: 'image/png', href: '/images/pwa-192x192.png' },
